            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                  ...
                  $sql="select pd.firstnames, pd.surnames,p.fecha,p.hora_de_entrada,p.hora_de_salida from presentismo as p inner join personal_data as pd on p.id_usuario=pd.id;";
                      ...
                      $result = mysqli_stmt_get_result($stmt);
                         ...
                         while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                          ...
                          <div class="custom-control custom-radio">
                            <input class="custom-control-input custom-control-input-success" type="radio" id="customRadio"  checked>
                            <label for="customRadio" class="custom-control-label">'.$row['firstnames'].'<br>'.$row['surnames'].'</label>
                          </div>
                          </td>
                          <td>'.$row['fecha'].'</td>
